  ...
  class IssueAdd extends React.Component {
    ...
    render() {
      return (
          ...
          <TextInput placeholder="Owner" onChangeText={newowner=>{this.setOwner(newowner)}}/>
          <TextInput placeholder="Title" onChangeText={newtitle=>{this.setTitle(newtitle)}}/>
...
class BlackList extends React.Component {
    ...
    return (
        ...
        <TextInput placeholder='Blacklist User' onChangeText={newname=>{this.setName(newname)}}/>
